 ...
 * 参考GifDrawable
 */
public class DGifDrawable extends Drawable implements Animatable, Runnable {
    private static final String TAG = "DGifDrawable";
    /**
    ...
    public static interface OnFinishedListener {
         ...
         */
        public abstract void onFinished(DGifDrawable drawable);
    }
    ...
    private final DGifFrame mFrameSequence;
    private final DGifFrame.State mFrameSequenceState;
    ...
    private Runnable mDecodeRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (schedule) {
                scheduleSelf(DGifDrawable.this, mNextSwap);
            }
    ...
    private Runnable mFinishedCallbackRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (mOnFinishedListener != null) {
                mOnFinishedListener.onFinished(DGifDrawable.this);
            }
        }
    };
    ...
    public DGifDrawable(DGifFrame frameSequence) {
        this(frameSequence, sAllocatingBitmapProvider);
    }

    public DGifDrawable(DGifFrame frameSequence, BitmapProvider bitmapProvider) {
